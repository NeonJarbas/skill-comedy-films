...
PLUGIN_ENTRY_POINT = 'skill-comedy-films.jarbasai=skill_comedy_films:ComedyFilmsSkill'

setup(
    # this is the package name that goes on pip
    name='ovos-skill-comedy-films',
    version='0.0.1',
    description='ovos classic scifi horror skill plugin',
    url='https://github.com/JarbasSkills/skill-comedy-films',
    author='JarbasAi',
